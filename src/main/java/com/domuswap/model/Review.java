...
public class Review {
    ...
    public Integer getCheckinExperienceRating() { return checkinExperienceRating; }
    public void setCheckinExperienceRating(Integer checkinExperienceRating) { this.checkinExperienceRating = checkinExperienceRating; }
