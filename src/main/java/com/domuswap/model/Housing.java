...
public class Housing {
    ...
    public Long getId() { return housing_id; }
    ...
    public void setImageUrl(String imageUrl) { this.photo_1 = imageUrl; }
    ...
    public List<RequestedService> getServices() { return services; }
    public void setServices(List<RequestedService> services) { this.services = services; }
