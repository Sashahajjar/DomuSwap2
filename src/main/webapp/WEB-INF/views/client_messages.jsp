...
<body>
    <div class="nav-menu">
        ...
        <a href="/owner/listings?ownerId=${param.ownerId}">My Listings</a>
        <a href="/client-messages?ownerId=${param.ownerId}">Client Messages</a>
            ...
            fetch(`/api/messages/${userId}?ownerId=${ownerId}`)
                ...
                .then(messages => {
                    ...
                    chatMessages.innerHTML = messages.map(msg => `
                        <div class="message ${msg.sender.id == ownerId ? 'message-sent' : 'message-received'}">
                            ${msg.content}
                        </div>
                    `).join('');
